...
typedef NS_ENUM(NSInteger, BLAccountErrCodeEnum) {
    ...
    //APPSDK自身判断返回
    /** 系统／网络异常错误 */
    BL_ACCOUNT_ERR_UNKNOWN = -3001,
    /** 参数错误 */
    BL_ACCOUNT_ERR_PARAM = -3002,
    /** 未登录异常 */
    BL_ACCOUNT_ERR_NOT_LOGIN = -3003,
};
...
/**
 Family Error Code Enum
 */
typedef NS_ENUM(NSInteger, BLFamilyErrCodeEnum) {
    /** 成功 */
    BL_FAMILY_SUCCESS = 0,
    
    /** 系统／网络异常错误 **/
    BL_FAMILY_UNKNOW_ERROR = -3201,
    /** 输入参数错误 */
    BL_FAMILY_INPUT_ERROR = -3202,
    /** 账户未登陆 */
    BL_FAMILY_NOT_LOGIN_ERROR = -3203,
};
