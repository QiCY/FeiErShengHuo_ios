...
//设置虚线边框
-(void)addImaginaryLineBorderwithWidth:(CGFloat )width withHeight:(CGFloat)height
{
    //添加虚线边框
    CAShapeLayer *borderLayer = [CAShapeLayer layer];
    borderLayer.bounds = CGRectMake(1, 1, width, height);
...
-(void)XUaddBottomBorderandWidth:(CGFloat) borderWidth
{
