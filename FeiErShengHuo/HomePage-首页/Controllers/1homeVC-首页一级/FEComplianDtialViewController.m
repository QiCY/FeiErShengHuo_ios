//
//  FEComplianDtialViewController.m
//  FeiErShengHuo
//
...
@interface FEComplianDtialViewController ()<UITableViewDataSource,UITableViewDelegate,UICollectionViewDataSource,UICollectionViewDelegate>
{
...
@property(nonatomic,strong)FESuggestModel *Smodel;

@end

@implementation FEComplianDtialViewController
...
-(void)DdoRequest
{
    ...
    [dic setObject:[NSNumber numberWithInt:0] forKey:@"repaireType"];
    [dic setObject:_Model.adviceId forKey:@"repaireId"];
    ...
    [[FEBSAFManager sharedManager]doOperationRequestHttpWithMethod:POST withPath:str withDictionary:dic withSuccessBlock:^(NSDictionary *dic) {
        ...
        self.Smodel=[FESuggestModel mj_objectWithKeyValues:dic[@"xcommunityAdvice"]];
        
        if ([_Smodel.adviceResolveInfo isEqualToString:@""]) {
            huifuLab.text=@"暂未回复";
            //_Smodel.adviceResolveInfo;
            
        }
        else{
            huifuLab.text=_Smodel.adviceResolveInfo;
        }
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    NSArray *array=@[@"业主信息",@"投诉内容",@"业主建议",@"业主图片",@"物业回复"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil)
    {
        ...
        if (indexPath.section==1) {
            _adviceContentLab=[MYUI createLableFrame:CGRectMake(10, 5, MainW-20, 20) backgroundColor:[UIColor clearColor] text: self.Smodel.adviceContent textColor:TxTGray_Color1 font:[UIFont systemFontOfSize:13] numberOfLines:0 adjustsFontSizeToFitWidth:NO];
            [cell addSubview:_adviceContentLab];
            
        }
        if (indexPath.section==2) {
            _requirementAdviceLab=[MYUI createLableFrame:CGRectMake(10, 5, MainW-20, 20) backgroundColor:[UIColor clearColor] text:self.Smodel.requirementAdvice textColor:TxTGray_Color1 font:[UIFont systemFontOfSize:13] numberOfLines:0 adjustsFontSizeToFitWidth:NO];
            [cell addSubview:_requirementAdviceLab];
            
        }
         //NSMutableArray *array=self.Smodel.pictureMap;
        ...
        if (indexPath.section==4) {
            huifuLab=[MYUI createLableFrame:CGRectMake(10, 5, MainW-20, 20) backgroundColor:[UIColor clearColor] text:@"暂未回复" textColor:TxTGray_Color1 font:[UIFont systemFontOfSize:13] numberOfLines:0 adjustsFontSizeToFitWidth:NO];
...
//            [cell addSubview:connectWUYEBtn];
    ...
    _adviceContentLab.text=self.Smodel.adviceContent;
    _requirementAdviceLab.text=self.Smodel.requirementAdvice;
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    FEpictureMapModel *model=self.picDataArray[indexPath.row];
    
    [cell.imgView sd_setImageWithURL:[NSURL URLWithString:model.xcommunityAdviceImages]];
