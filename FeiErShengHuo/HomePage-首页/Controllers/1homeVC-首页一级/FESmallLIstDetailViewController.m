//
//  FESmallLIstDetailViewController.m
//  FeiErShengHuo
//
...
@interface FESmallLIstDetailViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    UILabel *titlelab;
    UILabel *markTimelab;
    UILabel *contentLab;
...
@implementation FESmallLIstDetailViewController
...
-(void)doRequest
{
    NSString *str=@"020appd/xiaoxian/showDetail";
    ...
    [[FEBSAFManager sharedManager]doOperationRequestHttpWithMethod:POST withPath:str withDictionary:dic withSuccessBlock:^(NSDictionary *dic) {
        ...
        //announce
         ...
         height=[model.annonceText  heightWithFont:[UIFont systemFontOfSize:15] constrainedToWidth:MainW-20];
