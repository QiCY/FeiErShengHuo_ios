...
@interface FEAdviceTypeViewController ()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic,strong)UITableView *tableView;
@property(nonatomic,strong)NSMutableArray *dataArray;

@end

@implementation FEAdviceTypeViewController
- (instancetype)init
{
    self = [super init];
    if(self) {
...
-(void)doRequest
{
    NSString *str=@"020appd/advice/showType";
    ...
    [[FEBSAFManager sharedManager]doOperationRequestHttpWithMethod:POST withPath:str withDictionary:nil withSuccessBlock:^(NSDictionary *dic) {
        ...
        NSArray *array=[FEAdvicetype mj_objectArrayWithKeyValuesArray:dic[@"xcommunityTypes"]];
