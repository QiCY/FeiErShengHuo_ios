...
@interface FEWriteAdviceViewController () < UITableViewDelegate, UITableViewDataSource, UITextViewDelegate, choseDelegate, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, ZYQAssetPickerControllerDelegate, UINavigationControllerDelegate,
...
@implementation FEWriteAdviceViewController
...
- (void)publish
{
    ...
    {
        [FENavTool showAlertViewByAlertMsg:@"请描述投诉建议内容！" andType:@"提示"];
        return;
    }
...
- (void)textrequest
{
    ...
    NSString *str = @"020appd/advice/publishAdvice";
    NSMutableDictionary *dic =@{}.mutableCopy;
    [dic setObject:_xcommunityTypeId forKey:@"xcommunityTypeId"];
    [dic setObject:textView2.text forKey:@"adviceContent"];
    [dic setObject:textView3.text forKey:@"requirementAdvice"];
...
- (void)uploadOneImgAction
{
    ...
    {
        NSMutableDictionary *dic =@{}.mutableCopy;
        [dic setObject:_adviceId forKey:@"adviceId"];
        NSNumber *index = [NSNumber numberWithInt:i];
        [dic setObject:index forKey:@"numAdviceImage"];
        NSString *url = @"020appd/advice/uploadAdviceImage";
        ...
        [[FEBSAFManager sharedManager] POST:url
            ...
            constructingBodyWithBlock:^(id< AFMultipartFormData > _Nonnull formData) {
              ...
              [formData appendPartWithFileData:imageData name:@"imageAdvice" fileName:fileName mimeType:@"image/jpeg"]; //
            }
...
- (void)choseTypeClick
{
    FEAdviceTypeViewController *VC = [[FEAdviceTypeViewController alloc] init];
    VC.delegate = self;
    ...
    if (!cell)
    {
        ...
        switch (indexPath.section)
        {
            ...
            case 2:
                if (indexPath.row == 0)
                {
                    _textView = [[YHJTextView alloc] initWithFrame:CGRectMake(10, 5, MainW - 20, 120 - 10)];
                    _textView.backgroundColor = [UIColor whiteColor];
                    _textView.delegate = self;
                    _textView.tag = 10087;

                    _textView.myPlaceholder = @"请描述投诉建议内容";
