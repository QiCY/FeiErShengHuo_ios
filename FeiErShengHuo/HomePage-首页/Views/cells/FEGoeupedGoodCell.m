...
@implementation FEGoeupedGoodCell
...
-(void)creatUI
{
    _imageView=[MYUI creatImageViewFrame:CGRectMake(10, 10, 80, 80) imageName:@"Shopping_picture1"];
    ...
    //价格
    _priceLab=[MYUI createLableFrame:CGRectZero backgroundColor:[UIColor clearColor]  text:@"" textColor:[UIColor redColor] font:[UIFont systemFontOfSize:12] numberOfLines:0 adjustsFontSizeToFitWidth:NO];
...
-(void)setupCellWithModel:(FEGroupDetailModel *)model
{
    ...
    _priceLab.text=[NSString stringWithFormat:@"¥%.2f／件",GropedF];
    _numLab.text=[NSString stringWithFormat: @"%@人团",model.num];
