...
@interface FEgrainAndOilViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation FEgrainAndOilViewController
...
-(void)doRequest
{
    ...
    [dic setObject:[NSNumber numberWithInt:2] forKey:@"supplyFlag"];
