...
@interface FESmartListViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation FESmartListViewController
...
-(void)doRequest
{
    ...
    [dic setObject:[NSNumber numberWithInt:3] forKey:@"supplyFlag"];
