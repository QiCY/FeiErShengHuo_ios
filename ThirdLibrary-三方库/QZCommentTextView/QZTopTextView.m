    ...
    if ([self.countNumTextView isFirstResponder]) {
        ...
        [UIView animateWithDuration:0.5 animations:^{
            if (keyboardSize.height == 292.0 || keyboardSize.height == 282.0) {
                ...
                self.py_y = SCREEN_HEIGHT - keyboardSize.height - ConvertTo6_H(316)*CT_SCALE_Y + 26.0;
            }else{
                self.py_y = SCREEN_HEIGHT - keyboardSize.height - ConvertTo6_H(316)*CT_SCALE_Y ;
            }
...
-(void)makeSubView
{
    ...
    _issueBtn.frame=CGRectMake(MainW-60, self.countNumTextView.frame.origin.y+ ConvertTo6_H(200)*CT_SCALE_Y-ConvertTo6_H(54)*CT_SCALE_Y, ConvertTo6_W(114)*CT_SCALE_X, ConvertTo6_H(54)*CT_SCALE_Y);
...
//    [_issueBtn makeConstraints:^(MASConstraintMaker *make) {
//        make.right.equalTo(self.countNumTextView.right).offset(-10);
//        make.bottom.equalTo(self.countNumTextView.bottom).offset(0);
