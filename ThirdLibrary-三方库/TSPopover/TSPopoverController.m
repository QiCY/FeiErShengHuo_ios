...
- (void) showPopoverOnBottom:(CGPoint)senderPoint
{
    ...
    arrowDirection = TSPopoverArrowDirectionNone;
    popoverView = [[TSPopoverPopoverView alloc] init];
    popoverView.arrowDirection = TSPopoverArrowDirectionNone;
...
- (CGRect)popoverFrameRect:(CGRect)contentFrame senderPoint:(CGPoint)senderPoint
{
    ...
    if(self.arrowPosition == TSPopoverArrowPositionVertical){
        ...
        }else if (arrowDirection == TSPopoverArrowDirectionNone){
            popoverY = senderPoint.y + 20;
        }
        else{
            popoverY = senderPoint.y + ARROW_MARGIN;
        }
