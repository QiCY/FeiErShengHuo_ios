...
+ (void)initialize
{
    ...
    appearance.viewBackgroundColor = [UIColor colorWithWhite:1 alpha:0.7];
    appearance.titleColor = GLOBAL_BIG_FONT_COLOR;
    appearance.messageColor = GLOBAL_BIG_FONT_COLOR;
...
//			highlightedImage = [UIImage imageNamed:@"SIAlertView.bundle/button-cancel-d"];
			[button setTitleColor:GLOBAL_BIG_FONT_COLOR forState:UIControlStateNormal];
            [button setTitleColor:[UIColor colorWithRed:((float)((0x444444 & 0xFF0000) >> 16))/255.0 green:((float)((0x444444 & 0xFF00) >> 8))/255.0 blue:((float)(0x444444 & 0xFF))/255.0 alpha:0.5] forState:UIControlStateHighlighted];
			break;
		case SIAlertViewButtonTypeDestructive:
			...
			break;
        case SIAlertViewButtonTypeDelete:
