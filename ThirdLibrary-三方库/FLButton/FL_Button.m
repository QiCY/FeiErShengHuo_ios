...
#pragma mark - 居中对齐   //图片在左边
- (void)alignmentCenterImageLeft{
    
    //    设置图片的坐标
    CGFloat imageX = (fl_btnWidth - fl_labelWidth -fl_imageWidth - fl_padding) * 0.5;
    ...
    //    设置文本的坐标
    CGFloat labelX = CGRectGetMaxX(self.imageView.frame) + fl_padding;
...
- (void)layoutSubviews{
    ...
    else if (_status == FLAlignmentStatusCenterImageLeft){
        [self alignmentCenterImageLeft];
    }
